...
public class Words {
	...
	public static Map<String,String> uploadMapData(){
		...
		wordMap.put("base", "lowest;without any moral principles");
		...
		wordMap.put("churlish", "lacking manners or refinement;rude;surly");
		...
		wordMap.put("arriviste", "a person who has recently reached a position of power;ruthless amibition");
		...
		wordMap.put("apotheosize", "exalt to divine status;the highest point;idolize");
		...
		wordMap.put("untoward", "unexcepted & inappropriate;unfavourable;inconvenient");
		...
		wordMap.put("rudimentary", "being in the earliest stages of development;involing basic facts#percocious");
		...
		wordMap.put("genial", "friendly,cheerful,agreeable,conducive to comfort");
		...
		//advance word 1
		wordMap.put("apogee", "the highest point#apex#pinnacle");
		wordMap.put("cow", "to intimidate");
		wordMap.put("exegesis", "critical explanation or analysis,especially of a text");
		wordMap.put("chary", "cautious,suspiciously reluctant to do something");
		wordMap.put("byzantine", "intricate and complex");
		wordMap.put("fractious", "irritable and likely to cause disruption#irk#vex");
		wordMap.put("nadir", "the lowest point");
		wordMap.put("saturnine", "gloomy and not inclined to talk# morose");
		wordMap.put("choleric", "prone to outbursts of temper;easily angered");
		wordMap.put("vicissitude", "change in one's circumstances,usually for the worse");
		wordMap.put("hector", "to bully or intimidate");
		wordMap.put("beg", "assume something is true(usually a question)->beg to assume");
		wordMap.put("insufferable", "intolerable,difficult to endure");
		wordMap.put("truculent", "having a fierce,savage nature");
		wordMap.put("anathema", "a detested person;the source of somebody's hate");
		wordMap.put("defray", "to help pay the cost of,either in part or full");
		wordMap.put("catholic", "of broad scope;universal");
		wordMap.put("overweening", "arrogant;presumptuous");
		wordMap.put("lascivious", "lecherous;sexually perverted");
		wordMap.put("supercilious", "haughty#disdain");
		wordMap.put("apostate", "a person who has abandoned a religious faith or cause");
		wordMap.put("attenuate", "to weaken(in terms of intensity);to taper off/become thinner");
		wordMap.put("feckless", "lazy and irresponsible");
		
		//Advance word 2
		wordMap.put("quixotic", "wildly idealistic;impractical");
		wordMap.put("remonstrate", "to make objections while pleading");
		wordMap.put("pollyannaish", "extremely optimistic");
		wordMap.put("maudlin", "overly emotional and sad");
		wordMap.put("jaundiced", "to be biased against due to envy or prejudice");
		wordMap.put("gerrymander", "to manipulate voting districts in favor of a party");
		wordMap.put("tendentious", "likely to lean towards a controversial view");
		wordMap.put("execrate", "to curse and hiss at");
		wordMap.put("sententious", "to be moralizing,usually in a pompous sense");
		wordMap.put("mellifluous", "smooth and sweet-sounding");
		wordMap.put("phantasmagorical", "illusive;unreal");
		wordMap.put("malapropism", "the confusion of a word with another word that sounds similar");
		wordMap.put("pyrrhic", "a victory that comes at a great cost that the victory is not worthwhile");
		wordMap.put("excoriate", "to criticize very harshly");
		wordMap.put("palimpsest", "something that has been changed numerous times but the traces of the former iterations can still be seen");
		wordMap.put("factitious", "artificial,not natural");
		wordMap.put("jejune", "immature;childish;dull;lacking flavor");
		wordMap.put("limpid", "having clarity in terms of expression");
		wordMap.put("invective", "abusive or denunciatory language");
		
		//question gre guide words
		wordMap.put("conventional", "orthodox");
		wordMap.put("harbingers", "a person or thing that announces or signals the approach of another");
		wordMap.put("trifling", "unimportant or trivial");
		wordMap.put("rife", "(especially of something undesirable) of common occurrence; widespread;full of");
		wordMap.put("bogus", "not genuine or true");
		wordMap.put("faction", "small opposing group;dissension within an organization");
		wordMap.put("dissension", "disagreement that leads to discord");
		wordMap.put("fanciful", "very-imaginative and unrealistic");
		wordMap.put("prophetic", "accurately predicting what will happen in the future");
		wordMap.put("scrutinize", "examine or inspect closely and thoroughly");
		wordMap.put("illiberal", "opposed to liberal principles; restricting freedom of thought or behaviour");
		wordMap.put("disquiet", "a feeling of worry or unease");
		wordMap.put("penitent", "feeling or showing sorrow and regret for having done wrong; repentant");
		wordMap.put("pellucid", "translucently clear;easily understood");
		wordMap.put("skittish", "nervous or excitable; easily scared;frivolous or unpredictable");
		wordMap.put("tranquil", "free from disturbance; calm");
		wordMap.put("aloof", "not friendly or forthcoming; cool and distant");
		wordMap.put("foreground", "the most prominent or important position or situation");
		wordMap.put("transcend", "surpass;go beyond");
		wordMap.put("schism", "split or division between strongly opposed sections or parties, caused by differences in opinion or belief");
		wordMap.put("flout", "openly disregard;mock");
		wordMap.put("commonplace", "not unusual; ordinary");
		wordMap.put("elate", "make (someone) ecstatically happy");
		wordMap.put("abridged", "shorten (a book, film, speech, etc.) without losing the sense");
		wordMap.put("lurid", "unpleasantly bright in colour, especially so as to create a harsh or unnatural effect");
		wordMap.put("probity", "the quality of having strong moral principles; honesty and decency");
		wordMap.put("disapprobation", "strong disapproval, typically on moral grounds");
		wordMap.put("acquisitive", "excessively interested in acquiring money or material things");
		wordMap.put("complacency", "satisfaction with oneself or one's achievements");
		wordMap.put("diffuse", "spread over a wide area or between a large number of people");
		
		
		wordMap.put("persnickety", "excessive precision and attention to trivial details#meticulous");
		wordMap.put("lachrymose", "sad,tearful");
		wordMap.put("disbarred", "excluded");
		wordMap.put("tangential", "unrelated");
		wordMap.put("untenable", "indefensible");
		wordMap.put("stultified", "hamper;limit the growth");
		wordMap.put("spurn", "reject,snubbed");
		wordMap.put("cloistered", "sheltered & cut from others");
		wordMap.put("stonewall", "obstruct or hinder");
		wordMap.put("litanies", "any long & tedious address or recital");
		wordMap.put("cavil", "to criticize petty things#carping");
		wordMap.put("carping", "to criticize petty things#cavil");
		wordMap.put("gloat", "derive pleasure from anothers misfortune");
		wordMap.put("corral", "gather up");
		wordMap.put("halycon", "peaceful");
		wordMap.put("agog", "wildly excited");
		wordMap.put("foreboding", "a feeling of evil#ominous");
		wordMap.put("reviles", "insult with abuse");
		wordMap.put("snub", "insult with ignoring");
		wordMap.put("extols", "praise");
		wordMap.put("ancillary", "suplimentary information");
		wordMap.put("bygone", "belonging to an earlier time");
		wordMap.put("nebulous", "vague or ill-defined");
		wordMap.put("treacly", "overly sweet");
		wordMap.put("dysphoric", "distress");
		wordMap.put("unflappable", "calm & relaxed,not easily disturbed");
		wordMap.put("peril", "in danger#imperil");
		wordMap.put("imperil", "in danger#peril");
		wordMap.put("ebb", "to decline gradually");
		wordMap.put("cronies", "close friends#chums");
		wordMap.put("chums", "close friends#cronies");
		wordMap.put("attercation", "a noisy argument or disagreement,especially in public");
		wordMap.put("diminution", "diminish,reduce in size");
		wordMap.put("debonair", "cheerful,lively,charming,self-confident(of a man)");
		wordMap.put("hobbled", "hamstrung");
		wordMap.put("legion", "innumerable,vast number");
		wordMap.put("foil", "prevent from success");
		wordMap.put("torrid", "hot,vigorous,dry(no connections in relations)");
		wordMap.put("punctillious", "fastidious");
		wordMap.put("belabour", "attack something physically or verbally");
		wordMap.put("impugn", "attack as false or wrong");
		wordMap.put("misnomer", "incorrect or unsuitable name");
		wordMap.put("braggadocio", "vain & empty boasting");
		wordMap.put("wayward", "resistant to guidance or discipline");
		wordMap.put("subdued", "quiet,undercontrol,restrained");
		wordMap.put("derelict", "worn & broken down failing");
		wordMap.put("affectation", "behaviour,speech,writing that is pretentious & designed to impress");
		...
		wordMap.put("precocious", "characteristic of early development or maturity#rudimentory");
		...
		wordMap.put("percipitate", "cause to happen;done with very great haste");
		...
		wordMap.put("besiege", "surrender,harass,as with questions or requests, cause to feel distressed or worried");
		...
		wordMap.put("humdrum", "dull and lacking excitement#insipid");
		...
		wordMap.put("insipid", "dull or uninteresting#humdrum");
		...
		wordMap.put("conciliate", "to make peace with");
		wordMap.put("turpitude", "depravity;a depraved act");
		wordMap.put("mettlesome", "filled with courage or vigor");
		wordMap.put("disabuse", "to persuade somebody that his/her belief is not valid");
		wordMap.put("bilious", "irritable;always angry#vex#irk");
		wordMap.put("picayune", "trifling or petty(a person)");
		wordMap.put("venial", "easily excused or forgiven#pardonable");
		wordMap.put("impecunious", "lacking money;poor");
		wordMap.put("propitiate", "to placate or appease");
		wordMap.put("quisling", "a traitor");
		wordMap.put("vituperate", "to criticize harshly#berate");
		wordMap.put("mulct", "to defraud or swindle");
		wordMap.put("sybarite", "a person who indulges in luxury");
